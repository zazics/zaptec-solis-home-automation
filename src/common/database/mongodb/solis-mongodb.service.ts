/**
 * MongoDB implementation for Solis data storage
...
import { SolisData, SolisDataDocument } from '../../../solis/schemas/solis-data.schema';
import { SolisDataDTO } from '../../../solis/models/solis.model';
import { ISolisDatabase } from '../interfaces/solis-database.interface';
import { LoggingService } from '../../logging.service';

@Injectable()
export class SolisMongoDBService implements ISolisDatabase {
  private readonly context = SolisMongoDBService.name;
