/**
 * MongoDB implementation for Zaptec data storage and retrieval
 *
...
import { ZaptecData, ZaptecDataDocument } from '../../../zaptec/schemas/zaptec-data.schema';
...
@Injectable()
export class ZaptecMongoDBService implements IZaptecDatabase {
  private readonly context = ZaptecMongoDBService.name;
